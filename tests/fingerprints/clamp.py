...
def test_clamp_reference_values():
    ...
    expected_first_8 = np.array(
        [
            [3.818319, 0.081569, 0.166510, -0.048345,
             -0.207287, -0.002937, -0.048548, -0.057630],
            [3.977164, -0.037663, 0.113107, -0.017698,
             -0.243209, 0.029728, 0.109190, -0.227499],
            [2.587135, 0.015432, 0.012606, -0.038937,
             -0.059818, 0.035576, -0.049819, -0.073488],
        ],
        dtype=np.float32,
    )
