...
def calc_rdkit_2d(
    ...
    # the whole-molecule RDKit values come from MolecularProperties, which the rule
    # filters read as well, so they are computed once per molecule rather than here
    values = [
